...
export default function EditProfile({hideEditProfile}) {
    let profileName='My Profile';
    const[maturity,setMaturity]=useState('General Audience');
  ...
  return (
    <div className="expand-Container edit-Container">
        {choosePic &&  <ChoosePic hideChoosePic={hideChoosePic}/>}
        ...
        <div className="edit-container-inner">
            ...
            <div className="edit-middle-container">
                <div className="edit-middle-left"></div>
                ...
                <Form.Select className='dropmenu'>
                ...
                <Form.Control className='add-profile-name create-gameHandle' type="text" placeholder="Create Game Handle"/>
                <hr className='edit-line edit-line2'></hr>
                <p className='cancel-bottom option-heading option-heading2'>Maturity Settings:</p>
                <Form.Select className='dropmenu dropmenu2'onChange={handleMaturityChange}>
                ...
                <p className='cancel-bottom option-sub'>Show titles of <span className='bold4'>{maturity}</span> for this profile. </p>
